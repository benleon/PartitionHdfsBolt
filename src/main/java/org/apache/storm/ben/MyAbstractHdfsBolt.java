...
/**
 * Copy from AbstractHdfsBolt to reach unimplemented methods. 
 * Eventually either re-implement or move to 
 * @author bleonhardi
 *
 */
public abstract class MyAbstractHdfsBolt extends BaseRichBolt {
     ...
     * @throws IOException
     */
    public abstract void writeTuple(Tuple tuple) throws IOException;
     ...
     * @throws IOException
     */
    public abstract void syncTuples() throws IOException;
